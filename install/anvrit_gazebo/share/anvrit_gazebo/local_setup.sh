...
: ${AMENT_CURRENT_PREFIX:="/home/lalit/cyb_ws/install/anvrit_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/anvrit_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/anvrit_gazebo/environment/path.sh"
